  ...
  return (
    <section className="relative min-h-[65vh] flex items-center overflow-hidden pt-20">
      <div
        ...
        aria-label={imageAlt}
      />
      <div className="absolute inset-0 bg-gradient-to-r from-[#003087]/96 via-[#003087]/82 to-[#003087]/40" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="max-w-3xl">
          ...
          <p className="text-xl text-white/80 leading-relaxed max-w-2xl">{subtitle}</p>
        </div>
      </div>
    </section>
  );
